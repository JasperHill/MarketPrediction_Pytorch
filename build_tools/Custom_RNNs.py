...
class LSTM_Op(nn.Module):
    def __init__(self, batch_size, input_channels, input_dim, output_channels, output_dim):
        ...
        self.h = torch.zeros([batch_size, output_channels, output_dim])
    ...
    def reset_states(self):    
        ...
        self.h = torch.zeros([self.batch_size, self.output_channels, self.output_dim])
...
class MC_LSTM_Op(nn.Module):
    def __init__(self, batch_size, input_currencies, input_channels, input_dim, output_currencies, output_channels, output_dim):
        ...
        self.h = torch.zeros([batch_size, output_currencies, output_channels, output_dim])
    ...
    def reset_states(self):        
        self.c = torch.zeros([self.batch_size, self.output_currencies, self.output_channels, self.output_dim])
        self.h = torch.zeros([self.batch_size, self.output_currencies, self.output_channels, self.output_dim])
