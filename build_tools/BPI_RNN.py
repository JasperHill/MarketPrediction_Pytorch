...
from Custom_RNNs import LSTM_Op, MC_LSTM_Op, Categorical_LSTM_Op
...
class Categorical_LSTM_Model(nn.Module):
    def __init__(self, batch_size, input_channels, input_dim):
        super(Categorical_LSTM_Model, self).__init__()
        self.input_channels = input_channels
        self.input_dim = input_dim
        
        self.batch_size = batch_size

        self.lstm_op = Categorical_LSTM_Op(batch_size, input_channels, input_dim)
